var IdentitiesAssistant = Class.create({
	...
	initialize: function(settings) {
		...
		this.onToggleTokens = this.onToggleTokens.bind(this);
	...
	setup: function() {
		...
		this.controller.setupWidget('toggleTokens', { }, { value: false });
		...
		this.controller.listen('toggleTokens', Mojo.Event.propertyChange, this.onToggleTokens);
	},
	...
	cleanup: function(event) {
		...
		this.controller.stopListening('toggleTokens', Mojo.Event.propertyChange, this.onToggleTokens);
	},
	
	onToggleTokens : function(event) {
		var i, l;
		if (event.value) {
	...
	onIdListPropertyChanged: function(event) {
		...
		if (event.type === Mojo.Event.propertyChange) {
			...
			case 'name': event.model.nameSet(event.value); break;
	...
	onEnrollFailure: function(failData) {
		...
		Mojo.Controller.errorDialog(failData.exception);
	},
	handleCommand: function(event) {
		...
		if (event.type == Mojo.Event.command) {
			...
			case 'cmdEnrollCustom':
				this.settings.identityAdd('New', 'token', 'serial');
